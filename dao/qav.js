...
// http://211.149.218.190:5000/conversation?status=begin&conversation_id=17&agent_emp_id=v_200
// http://211.149.218.190:5000/conversation?status=end&conversation_id=17
exports.conversation = function(req, res, next) {
  ...
  if (status == 'begin') {
    ...
    sql = 'update tbl_conversation set end_time = utc_timestamp(3), status = "end" where id= ?';
